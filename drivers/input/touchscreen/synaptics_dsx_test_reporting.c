...
#define CFG_F54_RXCOUNT	24
#define TOUCH_RX_DEFAULT 24
#define TOUCH_TX_DEFAULT 13
static unsigned char rx = TOUCH_RX_DEFAULT;
static unsigned char tx = TOUCH_TX_DEFAULT;

static bool sysfs_is_busy = false;
static short FullRawMaxCap = 3666;
static short FullRawMinCap = 212;

static short FullRawCapUpperLimit[TOUCH_TX_DEFAULT*TOUCH_RX_DEFAULT] = {
3529,3499,3499,3504,3500,3519,3510,3515,3512,3516,3511,3495,2960,2978,2975,2949,2964,2958,2967,2957,2966,2971,2805,1775,
3130,3156,3149,3144,3133,3138,3120,3123,3108,3114,3104,3091,2988,2990,2992,2986,2986,2986,2995,2991,3000,3000,2996,2889,
3118,3140,3133,3126,3113,3118,3101,3101,3087,3088,3075,3062,2992,2988,2995,2980,2984,2986,2995,2990,2997,2999,3014,3136,
3099,3131,3122,3121,3103,3105,3087,3090,3077,3074,3062,3052,2999,2995,3000,2987,2993,2997,3004,2999,3010,3013,3025,3038,
3090,3122,3112,3107,3094,3097,3078,3082,3064,3058,3055,3040,3009,3008,3010,3001,3000,3005,3012,3010,3025,3022,3034,3009,
3083,3109,3100,3099,3082,3083,3069,3070,3057,3049,3045,3032,3019,3012,3018,3017,3010,3009,3019,3021,3032,3034,3047,3040,
3079,3108,3097,3092,3077,3074,3064,3062,3051,3047,3032,3025,3034,3027,3029,3023,3025,3019,3027,3029,3040,3043,3061,3237,
3071,3101,3095,3087,3070,3071,3058,3051,3047,3038,3023,3016,3057,3052,3053,3043,3044,3044,3053,3044,3058,3064,3082,3084,
3068,3100,3096,3090,3074,3071,3053,3052,3042,3038,3032,3017,3071,3070,3070,3056,3057,3062,3069,3062,3077,3083,3097,3060,
3065,3096,3097,3090,3077,3073,3056,3060,3038,3035,3035,3017,3091,3087,3088,3081,3082,3084,3091,3090,3097,3100,3116,3131,
3057,3090,3094,3088,3082,3075,3060,3061,3042,3036,3035,3018,3120,3116,3112,3103,3109,3105,3113,3109,3122,3121,3136,3300,
3051,3084,3087,3084,3081,3075,3062,3061,3042,3036,3030,3016,3149,3142,3140,3135,3138,3131,3134,3130,3140,3143,3155,3016,
3044,3074,3074,3077,3069,3068,3053,3052,3034,3023,3012,2997,3663,3662,3636,3615,3628,3624,3614,3562,3549,3534,3487,2117
}; //test_limit value*1000
static short FullRawCapLowerLimit[TOUCH_TX_DEFAULT*TOUCH_RX_DEFAULT] = {
1549,1554,1550,1546,1162,1544,1529,1535,1485,1264,1453,1533,1390,1389,1389,1379,1372,1346,1335,1373,1401,1391,1293,212,
1535,1542,1527,1526,838,1519,1470,1511,1499,1221,1470,1496,1418,1416,1413,1405,1377,1307,1308,1375,1426,1433,1417,1157,
1534,1545,1530,1529,833,1524,1457,1516,1503,1221,1495,1503,1436,1435,1435,1423,1388,1316,1345,1423,1402,1431,1440,1491,
1511,1519,1503,1503,829,1500,1447,1490,1480,1199,1467,1474,1419,1415,1415,1401,1396,1415,1410,1438,1426,1438,1417,1443,
1519,1526,1513,1512,828,1509,1436,1502,1489,1200,1475,1466,1442,1439,1437,1426,1419,1437,1433,1449,1449,1451,1442,1452,
1506,1511,1495,1495,826,1494,1428,1486,1472,1196,1458,1466,1433,1431,1428,1416,1409,1426,1421,1456,1440,1450,1431,1449,
1495,1516,1500,1500,824,1501,1420,1482,1476,1172,1463,1470,1437,1394,1445,1433,1425,1442,1434,1466,1459,1467,1452,1568,
1501,1508,1492,1489,825,1479,1411,1461,1470,1180,1455,1462,1455,1447,1417,1438,1429,1445,1438,1470,1460,1473,1454,1479,
1494,1501,1486,1484,824,1468,1404,1471,1465,1174,1448,1455,1456,1455,1423,1388,1432,1448,1440,1473,1463,1476,1456,1460,
1491,1505,1489,1489,828,1476,1400,1459,1470,1172,1437,1458,1480,1473,1475,1417,1412,1466,1460,1488,1479,1489,1474,1492,
1477,1494,1478,1478,826,1478,1399,1357,1389,1166,1404,1449,1477,1474,1473,1463,1442,1471,1459,1490,1477,1489,1473,1595,
...
static void mmi_rawimage_report(unsigned char *buffer)
{
	...
	memset(g_mmi_buf_f54raw_data, 0, F54_MAX_CAP_DATA_SIZE*rx*tx+F54_MAX_CAP_TITLE_SIZE);
...
static void mmi_RxtoRxshort1_report(unsigned char* buffer)
{
	...
	memset(g_mmi_RxtoRxshort_report, 0, F54_MAX_CAP_DATA_SIZE*rx+F54_MAX_CAP_TITLE_SIZE);//only Diagonal for V3
...
static void mmi_maxmincapacitance_report(unsigned char* buffer)
{
	...
	memset(g_mmi_maxmincapacitance_report, 0, F54_MAX_CAP_DATA_SIZE*F54_RAW_CAP_MIN_MAX_DATA_NUM+F54_MAX_CAP_TITLE_SIZE);
...
static void mmi_highresistance_report(unsigned char* buffer)
{
	...
	memset(g_mmi_highresistance_report, 0, F54_MAX_CAP_DATA_SIZE*F54_HIGH_RESISTANCE_DATA_NUM+F54_MAX_CAP_TITLE_SIZE);
...
static int mmi_runtest(int report_type)
{
	...
	case F54_FULL_RAW_CAP_MIN_MAX:
		...
		{
			g_mmi_maxmincapacitance_report = kmalloc(F54_MAX_CAP_DATA_SIZE*F54_RAW_CAP_MIN_MAX_DATA_NUM+F54_MAX_CAP_TITLE_SIZE, GFP_KERNEL);
			if (!g_mmi_maxmincapacitance_report)
				goto test_exit;
		}
	...
	case F54_FULL_RAW_CAP_RX_COUPLING_COMP:
		...
		{
			g_mmi_buf_f54raw_data = kmalloc(F54_MAX_CAP_DATA_SIZE*rx*tx+F54_MAX_CAP_TITLE_SIZE , GFP_KERNEL);
			if (!g_mmi_buf_f54raw_data)
				goto test_exit;
		}
	...
	case F54_HIGH_RESISTANCE:
		...
		{
			g_mmi_highresistance_report = kmalloc(F54_MAX_CAP_DATA_SIZE*F54_HIGH_RESISTANCE_DATA_NUM+F54_MAX_CAP_TITLE_SIZE, GFP_KERNEL);
			if (!g_mmi_highresistance_report)
				goto test_exit;
		}
	...
	case F54_RX_TO_RX1:
		...
		{
			g_mmi_RxtoRxshort_report = kmalloc(F54_MAX_CAP_DATA_SIZE*rx+F54_MAX_CAP_TITLE_SIZE, GFP_KERNEL);
			if (!g_mmi_RxtoRxshort_report)
				goto test_exit;
		}
